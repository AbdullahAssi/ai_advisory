...
function CTA() {
  return (
    <section className="py-12 bg-gradient-to-b sm:py-16 lg:py-20">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl xl:text-5xl font-pj">
            Transform Your Business With AI Advisory
          </h2>
          <p className="mt-4 text-base leading-7 text-gray-600 sm:mt-8 font-pj">
            Comprehensive AI solutions designed to enhance decision-making and
            drive growth
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
          <div className="md:p-8 lg:p-14">
            ...
            <p className="mt-5 text-base text-gray-600 font-pj">
              Expert guidance on implementing AI solutions tailored to your
              business needs, with personalized strategies that align with your
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
            ...
            <p className="mt-5 text-base text-gray-600 font-pj">
              Advanced analytics that transform your raw data into actionable
              insights, identifying patterns and trends to drive smarter
              business decisions.
            </p>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
            ...
            <p className="mt-5 text-base text-gray-600 font-pj">
              Leverage machine learning models to forecast market trends,
              customer behaviors, and business outcomes with increasing accuracy
              over time.
            </p>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-t md:border-gray-200">
            ...
            <p className="mt-5 text-base text-gray-600 font-pj">
              Streamline operations with intelligent automation that reduces
              manual tasks, minimizes errors, and allows your team to focus on
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
            ...
            <p className="mt-5 text-base text-gray-600 font-pj">
              Enhance customer satisfaction with AI-powered personalization that
              anticipates needs, recommends solutions, and delivers exceptional
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
            ...
            <p className="mt-5 text-base text-gray-600 font-pj">
              Identify new market opportunities and optimize resource allocation
              with AI-powered insights that drive sustainable business growth
